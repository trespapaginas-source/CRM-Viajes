...
-- 1. Actualizar la fecha específica en la tabla de planes en Supabase
...
WHERE id = '611faded-431f-48dd-8ed9-0cf9f30892ee';

-- 2. Actualizar los costos operativos y conceptos en la tabla de clientes en Supabase
...
-- 3. Registrar en el historial de modificaciones
